...
const displayMap = locations => {
  ...
  const routePoints = locations.map(loc => [loc.coordinates[1], loc.coordinates[0]]);
...
const stripe = Stripe('pk_test_51TWbrQCZ3h1mTv5YQEin5BHkdvFwx8Nngv1SgflNVlAucAzw9sBRENBP2KRF0qkqa2997xm3ojOoppWlTH24Lpa900YPFT1s6H');
